YOU NEED A WINDOWS MACHINE TO CONVERT OR RUN CONVERTED FILES. Run test.exe to see if this will work on your system, test.swf is the source of that file. File was taken from https://www.ultrasounds.com/
